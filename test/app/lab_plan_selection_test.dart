...
void main() {
  ...
  test(
    'selection count updates before the database reload completes',
    () async {
      final fixture = await _Fixture.create();
      addTearDown(fixture.dispose);
      final capturedPlan = await fixture.seedPlan();

      final write = fixture.controller.setLabPlanItemsChecked(capturedPlan, {
        'ferritin',
      }, true);
      ...
      await fixture.controller.setLabPlanItemsChecked(capturedPlan, {
        'tsh',
      }, true);
      expect(fixture.checkedIds(fixture.controller.labPlans.single), {
        'ferritin',
